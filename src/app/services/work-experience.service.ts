...
export class WorkExperienceService {
  ...
  // Expose the experiences as an Observable
  getExperiences(): Observable<Experience[]> {
    return this.experiencesSubject.asObservable();
  }

  // Optional: Add new experience dynamically
  addExperience(exp: Experience) {
    const current = this.experiencesSubject.getValue();
    this.experiencesSubject.next([...current, exp]);
  }

  // Optional: Update entire experiences array
